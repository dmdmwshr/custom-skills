...
- WSL 受管发布按 `$HOME/Documents/work/host-baseline/skills-management.md` 和 `scripts/publish_wsl_skills.py --skill <name>` 执行；Windows 按目标机现行 CC Switch 流程。两侧分别验收，不用一侧成功替代另一侧。
