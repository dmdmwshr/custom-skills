...
- 正常关闭由 adapter 按当地 ProjectBrowserV2 契约完成真实页面复用/用途留存与显式环境 finish，再释放本轮锁和事实；临时页关闭，protected/unknown 单独报告。最终返回 DONT_NOTIFY 需机器 finish 明确允许；人工验收报告实际结果与证据等级。
